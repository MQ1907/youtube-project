...
const handleBlur = () => {
  ...
  return (
    <div className="fixed z-50 flex justify-between items-center px-[1rem] py-[3rem] bg-[#0F0F0F] h-[10vh] w-full">
      <div className="flex">
        <FaBars
          className="mt-2 hover:cursor-pointer mr-6"
          size={24}
    ...
    <h1 className='text-2xl mt-1 ml-1 font-semibold text-white'>YouTube</h1> */}
        <div
          ...
          className="style-scope ytd-topbar-logo-renderer text-white cursor-pointer"
        >
          <ytd-logo className="style-scope ytd-topbar-logo-renderer">
            ...
            <yt-icon id="logo-icon" className="style-scope ytd-logo">
              ...
              <yt-icon-shape className="style-scope yt-icon">
                <icon-shape className="yt-spec-icon-shape ml-4">
                  <div
                    style={{
                      width: "100px",
                      height: "40px",
      ...
      <div className="flex mr-20">
        <form
          ...
          onFocus={handleFocus}
          onBlur={handleBlur}
          className="self-center m-[0.1rem] mr-7 flex border-[#222222] pr-4 rounded-full border-[1.2px] text-white  bg-[#222222]  text-base w-[643px] h-12 relative p-[1px]"
        >
          <input
            type="text"
          ...
          <button
            type="submit"
            className="top-3 right-1 absolute px-[1.25rem] bg-[#222222] text-white border-none focus:border-none"
          >
        ...
        <button
          type="submit"
          className="text-center px-[15px] bg-[#222222] text-white border-none focus:border-none rounded-full"
        >
          <img
      ...
      <div className="absolute right-0 mr-10 flex justify-around items-center">
        ...
        <img
          ...
          src="https://lh3.google.com/u/0/ogw/AF2bZyiL928aiwsUjolg_o4IqCUdizAySXxe7c9HtjSAI_URsw=s32-c-mo 1x, https://lh3.google.com/u/0/ogw/AF2bZyiL928aiwsUjolg_o4IqCUdizAySXxe7c9HtjSAI_URsw=s64-c-mo 2x "
          alt="ava"
        />
      </div>
